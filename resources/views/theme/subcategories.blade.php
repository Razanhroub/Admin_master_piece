                                                                ...
                                                                <form id="editCategoryForm-{{ $category->category_id }}"
                                                                    ...
                                                                    <div class="modal-body"
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input 
                                                                            style="width: 90%; margin-left: auto; margin-right: auto;"type="text"
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input style="width: 90%; margin-left: auto; margin-right: auto;" type="file"
                                                                ...
                                                                success: function(response) {
                                                                    if (response.message === 'No changes were made to the category information.') {
                                                                        Swal.fire('No Changes',
                                                                            'No updates were necessary as the information remained the same.',
                                                                            'info');
                                                                    } else {
                                                                        Swal.fire('Success!', response.message || 'Category updated successfully!',
                                                                                'success')
                                                                            .then(() => {
                                                                                location
                                                                            .reload(); // Reload the page to reflect updated category data
                                                                            });
                                                                    }
                                                                },
                                                                error: function(xhr) {
                                                                    ...
                                                                    '<br>'); // Flatten and join errors
                                                                    Swal.fire('Error!', errorMessages || 'Failed to update category.',
        ...
        function editCategory(categoryId) {
            ...
            $.ajax({
                ...
                success: function(category) {
                    ...
                    $('#editCategoryModal-' + categoryId + ' #category_name-' + categoryId).val(category
                        .category_name);
