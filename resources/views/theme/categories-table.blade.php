                                        ...
                                        @foreach ($categories as $index => $category)
                                            <tr style="font-size: 14px;">
                                                ...
                                                <td>
                                                    ...
                                                    <!-- Display the subcategory count inside the table cell -->
                                                    {{ $count }}
                                                </td>
                                                    ...
                                                    @foreach ($subcategories as $sub)
                                                        @if ($sub->category_id === $category->category_id)
                                                            @foreach ($recipes as $recipe)
                                                                @if ($recipe->sub_category_id === $sub->subcategory_id)
                                                                    <!-- Compare sub_category_id correctly -->
                                                                    @php
                                                                        // Count the recipes for this subcategory
                                                                        $recipeCount++;
                                                                    @endphp
                                                                @endif
                                                            @endforeach
                                                ...
                                                {{-- @dd($category->subcategories); <!-- Add this line to debug --> --}}
                                                <td style="display: flex; justify-content: space-between;">

                                                    <button type="button" class="btn btn-link p-0 px-2"
                                                        data-toggle="tooltip" data-placement="top" title="Edit"
                                                        {{-- onclick="editUser({{ $user->id }})"> --}} <i class="fa fa-pencil color-muted"></i>
                                                    </button>
                                                    ...
                                                    <!-- Delete Action -->
                                                    <form method="POST" {{-- action="{{ route('user-table.destroy', $user->id) }}" --}} action="#"
                                                        ...
                                                        <button type="button" class="btn btn-link p-0 px-2"
                                                            ...
                                                            {{-- onclick="confirmDelete({{ $user->id }})"> --}} <i class="fa fa-close color-danger"></i>
                                                        </button>
                                                    </form>
                                                </td>
                                            </tr>
