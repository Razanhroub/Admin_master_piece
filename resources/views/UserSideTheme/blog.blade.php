		...
		<section class="ftco-section">
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.php" class="block-20" style="background-image: url('{{ asset('Userassets') }}/images/image_1.jpg');">
              </a>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.php" class="block-20" style="background-image: url('{{ asset('Userassets') }}/images/image_2.jpg');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="#">June 25, 2019</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.php" class="block-20" style="background-image: url('{{ asset('Userassets') }}/images/image_3.jpg');">
              </a>
              <div class="text pt-3 pb-4">
                <div class="meta">
                  <div><a href="#">June 25, 2019</a></div>
